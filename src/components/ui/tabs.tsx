...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      // flex-wrap (not inline-flex/nowrap): with 6-7 triggers this used to
      // silently overflow past the panel's edge with no visible scroll
      // affordance — wrapping onto a second row keeps every tab reachable
